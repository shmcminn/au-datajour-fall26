...
Include at least one of the following features in either your critique or story pitch, to show you know how to use markdown (feel free to ask AI for help, but disclose that in your writing):
   * A heading
   * A bulleted list
   * An ordered list 
   * A table
...
You may use AI tools as an assistant for this assignment. For example, you may use AI to:

* explain how to create a Github repository or format Markdown
* troubleshoot a technical problem
* brainstorm possible story angles or sources, or ask for feedback on your ideas 

You are responsible for the reporting, critique, pitch, links, and final wording you submit. Check any information, suggestions, links, or code from an AI tool yourself. Do not use AI to write your critique or pitch and submit that writing as your own. 

Include a short **AI disclosure** at the end of your assignment. Name the tool or tools you used, describe what you used them for, and explain what you changed or verified. If you did not use AI, write: “AI disclosure: I did not use AI for this assignment.” For example:

> **AI disclosure:** I used ChatGPT to troubleshoot Markdown link formatting and brainstorm possible sources for my story pitch. I wrote the critique and pitch myself, checked the links, and verified the source suggestions independently.
